        ...
        //2
        maxFriends = function (userx){
            min = Number.MIN_VALUE;
            let userMaxFriends = [];
            for (const user of userx) {
                if (user.friends.length >= min){
                    min = user.friends.length;
                    userMaxFriends.push(user);
                }
            }
           
            for (const user of userMaxFriends) {
        ...
        console.log(maxBalanceComp(users))
        console.log(minBalanceComp(users))